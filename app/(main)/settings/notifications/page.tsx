  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <span style={{ fontSize: '14px', fontWeight: 800, color: '#0D307F' }}>Notifikasi</span>
      </div>
      ...
      <NotifRow
        ...
        label="Pengingat Scan"
        sub="Ingatkan untuk scan struk setiap hari"
      />
      <NotifRow
        ...
        sub="Ringkasan setiap Senin pagi"
      />
      <NotifRow
        ...
        sub="Notifikasi saat pengeluaran tinggi"
      />
      ...
      <NotifRow
        ...
        label="Fitur Baru"
        sub="Info update dan fitur terbaru"
      />
    </div>
  )
}