  ...
  return (
    <div style={{
      ...
      <div style={{ padding: '24px 16px 8px' }}>
        <div style={{ fontSize: '20px', fontWeight: 800, color: textPrimary }}>Pembaruan Keamanan</div>
        <div style={{ fontSize: '12px', color: textSecondary, marginTop: '4px' }}>
          Kelola kredensial akun kamu dengan aman.
        </div>
      </div>
      ...
      <div style={{ padding: '16px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
        ...
        <button onClick={handleUpdate} style={{
          ...
          {saved ? '✓ DIPERBARUI!' : 'PERBARUI PASSWORD'}
        </button>

        <div style={{ textAlign: 'center', fontSize: '11px', color: textSecondary }}>
          Semua perubahan dicatat untuk keamanan akun.
        </div>
      </div>
    </div>
  )
