    ...
    <div style={{ background: bg, minHeight: '100%', transition: 'background 0.3s' }}>
      ...
      <div style={{ background: '#0D307F', color: '#fff', padding: '18px', borderRadius: '20px', marginBottom: '14px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', marginBottom: '12px' }}>
          <h2 style={{ fontSize: '26px', fontWeight: 800, margin: 0, fontFamily: 'Georgia, serif' }}>$42,950.00</h2>
          <div style={{ background: 'rgba(255,255,255,0.12)', border: '0.5px solid rgba(255,255,255,0.2)', borderRadius: '8px', padding: '3px 8px', display: 'flex', alignItems: 'center', gap: '4px', fontSize: '11px', fontWeight: 700, color: '#4fe8a0' }}>
      ...
      <div style={{ marginBottom: '8px' }}>
        ...
        {activities.map((item, i) => (
          <div key={i} style={{
            ...
            <p style={{ fontSize: '13px', fontWeight: 800, margin: 0, color: item.neg ? textPrimary : '#1D9E75', flexShrink: 0 }}>
              {item.amount}
            </p>
          </div>
        ))}
